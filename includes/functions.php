...
function vietnix_csv_validate_file($file_path) {
    if (!file_exists($file_path)) {
        return array('valid' => false, 'message' => __('file không tồn tại', 'vietnix-csv-import'));
    }
    
    $file_info = pathinfo($file_path);
    if (strtolower($file_info['extension']) !== 'csv') {
        return array('valid' => false, 'message' => __('File phải là định dạng CSV', 'vietnix-csv-import'));
    }
    ...
    if (!$handle) {
        return array('valid' => false, 'message' => __('Không thể đọc file', 'vietnix-csv-import'));
    }
    ...
    if (empty($first_line)) {
        return array('valid' => false, 'message' => __('File rỗng', 'vietnix-csv-import'));
    }
    
    return array('valid' => true, 'message' => __('File hợp lệ', 'vietnix-csv-import'));
}
