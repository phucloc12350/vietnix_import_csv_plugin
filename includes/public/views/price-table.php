...
// Get table style from attributes
$table_style = isset($atts['style']) ? $atts['style'] : 'default';

?>

<div class="vietnix-price-table-wrapper vietnix-style-<?php echo esc_attr($table_style); ?>"
    id="<?php echo esc_attr($table_id); ?> vietnix-price-table-wrapper">
    ...
    <script type="application/json" class="vietnix-table-config">
    {
        ...
        "VIETNIX_IMPORT_CSV_PLUGIN_URL": "<?php echo esc_js(VIETNIX_IMPORT_CSV_PLUGIN_URL); ?>"
    }
    </script>
</div>