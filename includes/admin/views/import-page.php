    ...
    <div class="vietnix-csv-import-page">
        <div class="postbox">
            ...
            <div class="inside">
                <form id="vietnix-csv-import-form" method="post" enctype="multipart/form-data">
                    <?php wp_nonce_field('vietnix_csv_admin_nonce', 'nonce'); ?>

                    <table class="form-table">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <label for="csv_file"><?php _e('CSV File', 'vietnix-csv-import'); ?> <span
                            ...
                            <tr>
                                <th scope="row">
                                    <label
                                        for="clear_existing"><?php _e('Xoá hết dữ liệu tồn tại', 'vietnix-csv-import'); ?></label>
                                </th>
                                <td>
                                    <input type="checkbox" id="clear_existing" name="clear_existing" value="1" />
                                    <label
                                        for="clear_existing"><?php _e('Xoá hết dữ liệu tồn tại trước khi nhập', 'vietnix-csv-import'); ?></label>
                                    <p class="description">
                                        <?php _e('Cảnh báo: Hành động này sẽ xóa vĩnh viễn tất cả dữ liệu giá hiện tại.', 'vietnix-csv-import'); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label
                                        for="download_images"><?php _e('Tải hình ảnh về', 'vietnix-csv-import'); ?></label>
                                </th>
                                <td>
                                    <input type="checkbox" id="download_images" name="download_images" value="1"
                                        checked />
                                    <label
                                        for="download_images"><?php _e('Tự động tải hình ảnh từ URL về Media Library', 'vietnix-csv-import'); ?></label>
                                    <p class="description">
                                        ...
                                        <br>
                                        <strong><?php _e('Lưu ý:', 'vietnix-csv-import'); ?></strong>
                                        <?php _e('Quá trình này có thể mất thời gian nếu có nhiều hình ảnh.', 'vietnix-csv-import'); ?>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <p class="submit">
                        <input type="submit" name="submit" id="submit" class="button button-primary"
                            value="<?php _e('Import CSV', 'vietnix-csv-import'); ?>" />
                    ...
                    <div class="vietnix-stats-grid">
                        ...
                        <div class="stat-box">
                            <div class="stat-number">
                                <?php echo $last_import ? date_i18n(get_option('date_format') . ' ' . get_option('time_format'), strtotime($last_import)) : __('N/A', 'vietnix-csv-import'); ?>
                            </div>
                        ...
                        <div class="danger-zone">
                            ...
                            <button type="button" id="delete-all-data"
                                class="button button-secondary"><?php _e('Delete All Data', 'vietnix-csv-import'); ?></button>
                        </div>
                    </div>
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <p><?php _e('Bạn có thể hiển thị dữ liệu đó trên bất kỳ trang hoặc bài đăng nào bằng cách sử dụng mã ngắn:', 'vietnix-csv-import'); ?>
                </p>
