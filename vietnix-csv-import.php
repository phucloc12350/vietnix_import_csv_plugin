...
class VietnixCSVImport {
    ...
    public function admin_enqueue_scripts($hook) {
        ...
        wp_localize_script('vietnix-csv-admin-js', 'vietnixCSVAdmin', array(
            ...
            'messages' => array(
                'selectFile' => __('Please select a CSV file', 'vietnix-csv-import'),
                'confirmDelete' => __('Are you sure you want to delete all existing data before import?', 'vietnix-csv-import'),
                'confirmDeleteAll' => __('Are you sure you want to delete ALL data? This action cannot be undone!', 'vietnix-csv-import'),
                'connectionError' => __('Connection error. Please try again.', 'vietnix-csv-import'),
                'importSuccess' => __('CSV imported successfully!', 'vietnix-csv-import'),
                'importError' => __('Import failed. Please check your CSV file.', 'vietnix-csv-import'),
                'deleteSuccess' => __('Data deleted successfully!', 'vietnix-csv-import'),
                'deleteFailed' => __('Delete failed', 'vietnix-csv-import')
            )
        ));
    }
    ...
    private function includes() {
        ...
        if (is_admin()) {
            ...
            require_once VIETNIX_CSV_PATH . 'includes/admin/class-view-data.php';
        }
